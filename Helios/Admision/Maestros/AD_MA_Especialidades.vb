Public Class AD_MA_Especialidades
    Private obe As BE.AdmisionBE.SG_AD_TB_ESPECIALIDADES
    Private obr As BL.AdmisionBL.SG_AD_TB_ESPECIALIDADES
    Private lNew As Boolean = False

    Public Sub New()
        InitializeComponent()
        obe = New BE.AdmisionBE.SG_AD_TB_ESPECIALIDADES
        obr = New BL.AdmisionBL.SG_AD_TB_ESPECIALIDADES
    End Sub
...
Err_Valida:
    ...
    Private Sub pLoad() Handles MyBase.Load
        ...
        obe.ES_IDEMPRESA = gInt_IdEmpresa

        Dim obj As New DataTable
        Dim combo_cc As New BL.AdmisionBL.SG_AD_TB_Centro_Costo
        ucb_cc.DataSource = combo_cc.get_grilla(gInt_IdEmpresa)
        ucb_cc.ValueMember = "CC_CODIGO"
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .ES_ABREVIATURA = txt_DesCorto.Text
            .ES_DESCRIPCION = txt_Descripcion.Text
            .ES_IDEMPRESA = gInt_IdEmpresa
            .ES_IDCC = ucb_cc.Value
        End With
    ...
    Private Sub Tool_Editar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Editar.Click
        ...
        ucb_cc.Value = ug_Lista.ActiveRow.Cells(3).Value
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If Preguntar("Seguro de Eliminar?") Then
            obe.ES_ID = ug_Lista.ActiveRow.Cells(0).Value
            obe.ES_IDEMPRESA = gInt_IdEmpresa
