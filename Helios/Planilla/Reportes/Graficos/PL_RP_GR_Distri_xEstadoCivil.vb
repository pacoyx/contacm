Public Class PL_RP_GR_Distri_xEstadoCivil

    Private Sub PL_RP_GR_Distri_xEstadoCivil_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Data_Graficos()
        ...
        uc_grafico.Data.DataSource = reporteBL.get_Gra_Distribucion_x_Estado_Civil(gInt_IdEmpresa, uchk_Cesados.Checked)
        uc_grafico.TitleTop.Text = "Distribución por Estado Civil"
        reporteBL = Nothing
    End Sub
