Public Class AD_MA_GrupoSanguineo
    Private obe As BE.AdmisionBE.SG_AD_TB_GrupoSanguineo
    Private obr As BL.AdmisionBL.SG_AD_TB_GrupoSanguineo
    Private lNew As Boolean = False

    Public Sub New()
        InitializeComponent()
        obe = New BE.AdmisionBE.SG_AD_TB_GrupoSanguineo
        obr = New BL.AdmisionBL.SG_AD_TB_GrupoSanguineo
    End Sub
...
Err_Valida:
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .GS_NOMBRE = txt_Descripcion.Text
            .GS_ESTADO = urb_Estado.Value
        End With
    ...
    Private Sub Tool_Editar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Editar.Click
        ...
        urb_Estado.Value = ug_Lista.ActiveRow.Cells(2).Value
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If Preguntar("Seguro de Eliminar?") Then
            obe.GS_ID = ug_Lista.ActiveRow.Cells(0).Value
