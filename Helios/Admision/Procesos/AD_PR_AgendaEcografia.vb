Public Class AD_PR_AgendaEcografia
    Dim IGVTasa As Double

    Private Sub AD_PR_AgendaEcografia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Cargar_Combos()
    ...
    Public Sub Cargar_Agenda(ByVal fecha As String, ByVal servicio As String, ByVal Medico As String, ByVal Turno As Integer)
        ...
        ug_intervalos.DataSource = programacionBL.get_Programacion_x_Fecha_Ecograf(CDate(fecha).ToShortDateString, servicio, Medico, gInt_IdEmpresa, Turno)
        ...
        If (ug_intervalos.ActiveRow.Cells(0).Value = 0 And ug_intervalos.ActiveRow.Cells(1).Value = 0) Or ug_intervalos.ActiveRow.Cells(9).Value = "Citado" Then
            With AD_PR_ReservaCita
                ...
                If ug_intervalos.ActiveRow.Cells(9).Value = "Citado" Then
                    ...
                    clienteBE.HC_TDOC = ug_intervalos.ActiveRow.Cells(15).Value
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If ug_intervalos.ActiveRow.Cells(10).Value.ToString <> "" Then
