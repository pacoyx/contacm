Public Class AD_RE_GraficoAtenciones
    ...
    Private Sub Cargar_Comprobantes()
        ...
        obj = ReportBL.get_Gra_Atencion(uce_Mes.Value, CDate(udte_desde.Value).ToShortDateString, CDate(udte_hasta.Value).ToShortDateString, Now.Year, uce_tipo.Value)
