Public Class AD_MA_Recomendado
    Private obe As BE.AdmisionBE.SG_AD_TB_RECOMENDADO
    Private obr As BL.AdmisionBL.SG_AD_TB_RECOMENDADO
    Private lNew As Boolean = False

    Public Sub New()
        InitializeComponent()
        obe = New BE.AdmisionBE.SG_AD_TB_RECOMENDADO
        obr = New BL.AdmisionBL.SG_AD_TB_RECOMENDADO
    End Sub
...
Err_Valida:
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .RE_NOMBRE = txt_Descripcion.Text
            .RE_ESTADO = urb_Estado.Value
        End With
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If Preguntar("Seguro de Eliminar?") Then
            obe.RE_ID = ug_Lista.ActiveRow.Cells(0).Value
