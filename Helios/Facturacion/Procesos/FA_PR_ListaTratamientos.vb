Public Class FA_PR_ListaTratamientos
    ...
    Private Sub Cargar()
        Try
            Me.Text = "Lista de Tratamientos"

            Dim paBL As New BL.FacturacionBL.SG_FA_TB_PAQUETE_CAB
            Dim obe As New BE.FacturacionBE.SG_FA_TB_PAQUETE_CAB
            obe.PC_IDEMPRESA = gInt_IdEmpresa
            Dim obj As New DataTable
            paBL.SEL03(obe, obj)
            Dv_data = obj.DefaultView
    ...
    Private Sub txt_filtro_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_filtro.ValueChanged
        Try
            ...
            Select Case uce_campos.Value
                ...
                Case 1
                    Dv_data.RowFilter = "PC_ID like '" & txt_filtro.Text.Trim & "%'"
                Case 2
                    Dv_data.RowFilter = "PC_DESCRIPCION like '%" & txt_filtro.Text.Trim & "%'"
