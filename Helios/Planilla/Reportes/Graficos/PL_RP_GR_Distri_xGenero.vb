Public Class PL_RP_GR_Distri_xGenero

    Private Sub PL_RP_GR_Distri_xGenero_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Data_Graficos()
        ...
        uc_grafico.Data.DataSource = reporteBL.get_Gra_Distribucion_x_Genero(gInt_IdEmpresa, uchk_Cesados.Checked)
        uc_grafico.TitleTop.Text = "Distribución por Genero"
        reporteBL = Nothing
    End Sub
