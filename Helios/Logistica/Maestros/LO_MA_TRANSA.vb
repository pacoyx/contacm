Public Class LO_MA_TRANSA
    Dim boton As Boolean = False
    Private Sub LO_MA_TRANSA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Call cargar_grilla()
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        If txt_cod.Text = "" Or txt_des.Text = "" Then
            ...
            Exit Sub
        End If
        Dim trBL As New BL.LogisticaBL.SG_LO_TB_TRANSA
        Dim trBE As New BE.LogisticaBE.SG_LO_TB_TRANSA
        If boton = True Then
    ...
    Public Sub cargar_grilla()
        ...
        udg_tr.DisplayLayout.Bands(0).Columns(3).Hidden = True
        trBE = Nothing
        trBL = Nothing
    End Sub
    ...
    Private Sub Tool_Editar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Editar.Click
        ...
        Else
            ...
            txt_sum.Text = udg_tr.ActiveRow.Cells(2).Value
    ...
    Private Sub txt_sum_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_sum.KeyPress
        e.KeyChar = fKeyPress(e.KeyChar, txt_sum.Text, 1)
        e.Handled = (e.KeyChar = "")
    End Sub
