Public Class PL_MA_Parametros
    Dim Bol_Nuevo As Boolean = False


    Private Sub PL_MA_Parametros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Tool_Grabar_Click(sender As System.Object, e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        Dim parametroBL As New BL.PlanillaBL.SG_PL_TB_PARAMETROS
        Dim parametroBE As New BE.PlanillaBE.SG_PL_TB_PARAMETROS

        With parametroBE
            .AD_TIPO = txt_tipo.Text
            .AD_NOMBRE = txt_codigo.Text
            .AD_VALOR = txt_valor.Text
            .AD_IDEMPRESA = gInt_IdEmpresa
        End With
