Public Class LO_RE_Consumo
    ...
    Private Sub Tool_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Consultar.Click
        ...
        ug_data.DataSource = obr.Consumo(uce_Almacen.Value, uce_Mes.Value, Val(txt_año.Text))
        ug_data.UpdateData()
    End Sub
    ...
    Private Sub Tool_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Exportar.Click
        Dim str_nombre_arc_exc As String = "Consumo " & Date.Now.Day & Date.Now.Month & Date.Now.Year & Date.Now.Hour & Date.Now.Minute & Date.Now.Second & ".xls"
        Try
