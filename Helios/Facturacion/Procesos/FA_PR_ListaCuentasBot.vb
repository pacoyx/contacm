Public Class FA_PR_ListaCuentasBot
    ...
    Private Sub FA_PR_ListaAyuda_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        obr.SEL11(HisoriaP, obj)
        ug_data.DataSource = obj

        Me.KeyPreview = True
    End Sub

    Private Sub ubtn_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
