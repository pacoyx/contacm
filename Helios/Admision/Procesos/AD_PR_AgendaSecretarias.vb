Public Class AD_PR_AgendaSecretarias
    ...
    Private Sub uce_Servicio_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles uce_Servicio.SelectionChanged
    ...
    Public Sub Cargar_Agenda(ByVal fecha As String, ByVal servicio As String, ByVal Medico As String, ByVal Turno As Integer)
        ...
        If uce_Servicio.Value = 7 Then
            ...
            ug_intervalos.DisplayLayout.Bands(0).Columns("Estado").Hidden = True
        ...
        Else
            ...
            ug_intervalos.DisplayLayout.Bands(0).Columns("Estado").Hidden = False
    ...
    Private Sub Tool_PasoConsulta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_PasoConsulta.Click
        If ug_intervalos.Rows.Count = 0 Then Exit Sub
    ...
    Private Sub ug_intervalos_DoubleClickCell(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.DoubleClickCellEventArgs) Handles ug_intervalos.DoubleClickCell
        If uce_Servicio.Value = 7 Then
            ...
            End If
        Else
            Call Tool_PasoConsulta_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub uce_Medico_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles uce_Medico.SelectionChanged
        Call Cargar_Agenda(udte_fecha.Value, uce_Servicio.Value, uce_Medico.Value, ucbo_Turno.Value)
    End Sub

    Private Sub Tool_Receta_Click(sender As System.Object, e As System.EventArgs) Handles Tool_Receta.Click
        If ug_intervalos.Rows.Count = 0 Then Exit Sub
        If ug_intervalos.ActiveRow.Cells(9).Value <> "Ocupado" Then
            With AD_PR_Recetas_Medicas
    ...
    Private Sub ug_intervalos_InitializeLayout(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles ug_intervalos.InitializeLayout
