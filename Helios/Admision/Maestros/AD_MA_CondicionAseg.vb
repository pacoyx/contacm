Public Class AD_MA_CondicionAseg
    Private obe As BE.AdmisionBE.SG_AD_TB_CONDICION_ASEGURADO
    Private obr As BL.AdmisionBL.SG_AD_TB_CONDICION_ASEGURADO
    Private lNew As Boolean = False

    Public Sub New()
        InitializeComponent()
        obe = New BE.AdmisionBE.SG_AD_TB_CONDICION_ASEGURADO
        obr = New BL.AdmisionBL.SG_AD_TB_CONDICION_ASEGURADO
    End Sub
...
Err_Valida:
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .CA_NOMBRE = txt_Descripcion.Text
            .CA_ESTADO = urb_Estado.Value
        End With
