...
Public Class FA_PR_Emi_ComproFacturacion
...
Err_Valida:
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        Try
            comprobanteBL.Insert_Caja_Prestaciones(comprobanteBE, voucherConta, 1)
    ...
    'Private Sub txt_IdCuenta_EditorButtonClick(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinEditors.EditorButtonEventArgs)
    '    Select Case e.Button.Key
    '        Case "ayuda"
    ...
    '    End Select
    'End Sub
    'Private Sub txt_IdCuenta_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    If txt_IdCuenta.Text.Trim.Length = 0 Then
    '        Iniciar_Ventana()
    '    End If
    'End Sub
    'Private Sub txt_IdCuenta_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
    '        Call Buscar_Cuenta()
    '    End If
    ...
    Private Sub uck_Redondear_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles uck_Redondear.CheckedChanged
        If bol_nuevo Then
            If uck_Redondear.Checked = True Then
                ...
                AgregarDetalle(1, IIf(Precio > 0, 214, 215), "REDONDEO", Precio, 0, 0, Precio, 0, Precio, 0, 0)
            Else
                For i As Integer = 0 To ug_Detalle.Rows.Count - 1
                    If ug_Detalle.Rows(i).Cells("IdArticulo").Value = "214" Or ug_Detalle.Rows(i).Cells("IdArticulo").Value = "215" Then
