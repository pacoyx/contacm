Public Class PL_RP_GR_Grado_Instruccion

    Private Sub PL_RP_GR_Grado_Instruccion_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Call Cargar_Data_Graficos()
    End Sub

    Private Sub Cargar_Data_Graficos()
        Dim reporteBL As New BL.PlanillaBL.SG_PL_Reportes
        uc_grafico.Data.DataSource = reporteBL.get_Gra_Distribucion_x_Grado_Ins(gInt_IdEmpresa, uchk_Cesados.Checked)
        uc_grafico.TitleTop.Text = "Distribución por Grado de Instrucción"
        reporteBL = Nothing
    End Sub
