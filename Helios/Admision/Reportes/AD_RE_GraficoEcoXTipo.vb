Public Class AD_RE_GraficoEcoXTipo
    ...
    Private Sub Cargar_Comprobantes()
        ...
        obj = ReportBL.get_Gra_EcoXTipo(gInt_IdEmpresa, uce_Mes.Value, CDate(udte_desde.Value).ToShortDateString, CDate(udte_hasta.Value).ToShortDateString, Now.Year, uce_tipo.Value)
