Public Class LO_MA_Forma_Presentacion
    Private obe As BE.LogisticaBE.SG_LO_TB_FORMA_PRESENTACION
    Private obr As BL.LogisticaBL.SG_LO_TB_FORMA_PRESENTACION
    Private lNew As Boolean = False
    Public Sub New()
        InitializeComponent()
        obe = New BE.LogisticaBE.SG_LO_TB_FORMA_PRESENTACION
        obr = New BL.LogisticaBL.SG_LO_TB_FORMA_PRESENTACION
    End Sub
...
Err_Valida:
    ...
    Private Sub LO_MA_Forma_Presentacion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .FP_ID = txt_id.Text
            .FP_NOMBRE = txt_Nombre.Text
            .FP_IDEMPRESA = gInt_IdEmpresa
        End With
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If Preguntar("Seguro de Eliminar?") Then
            obe.FP_ID = ug_Lista_Num.ActiveRow.Cells(0).Value
            obe.FP_IDEMPRESA = gInt_IdEmpresa
