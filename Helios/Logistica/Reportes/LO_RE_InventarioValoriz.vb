Public Class LO_RE_InventarioValoriz
    ...
    Private Sub Tool_Consultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Consultar.Click
        ...
        ug_data.DataSource = obr.SEL04(obe, uce_Mes.Value, Val(txt_año.Text), gInt_IdEmpresa)
        ug_data.UpdateData()
    End Sub
    ...
    Private Sub Tool_Imprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Imprimir.Click
        ...
        Dim nom_reporte As String = "SG_LO_03.RPT"
        Dim crystalBL As New LR.ClsReporte
        Dim dt_data As New DataTable
        obe.SA_IDALMACEN = uce_Almacen.Value
        dt_data = obr.SEL04(obe, uce_Mes.Value, Val(txt_año.Text), gInt_IdEmpresa)

        crystalBL.Muestra_Reporte(gStr_RutaRep & "\" & nom_reporte, dt_data, "", "Mes;" & uce_Mes.Text, "ayo;" & Val(txt_año.Text), "pEmpresa;" & gStr_NomEmpresa)
    ...
    Private Sub Tool_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Exportar.Click
        Dim str_nombre_arc_exc As String = "Valorizado " & Date.Now.Day & Date.Now.Month & Date.Now.Year & Date.Now.Hour & Date.Now.Minute & Date.Now.Second & ".xls"
        Try
            Me.Cursor = Cursors.WaitCursor
