Public Class LO_MA_Generico
    Private obe As BE.LogisticaBE.SG_LO_TB_GENERICO
    Private obr As BL.LogisticaBL.SG_LO_TB_GENERICO
    Private lNew As Boolean = False
    Public Sub New()
        InitializeComponent()
        obe = New BE.LogisticaBE.SG_LO_TB_GENERICO
        obr = New BL.LogisticaBL.SG_LO_TB_GENERICO
    End Sub
...
Err_Valida:
    ...
    End Sub
    Private Sub LO_MA_Generico_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Tool_Grabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Grabar.Click
        ...
        With obe
            .GE_ID = txt_id.Text
            .GE_DESCRIPCION = txt_Nombre.Text
            .GE_IDEMPRESA = gInt_IdEmpresa
        End With
    ...
    Private Sub Tool_Eliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tool_Eliminar.Click
        ...
        If Preguntar("Seguro de Eliminar?") Then
            obe.GE_ID = ug_Lista_Num.ActiveRow.Cells(0).Value
            obe.GE_IDEMPRESA = gInt_IdEmpresa
